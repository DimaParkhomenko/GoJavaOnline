...
public class FileTestDrive {
	...
	private static void readUsersAnswer() throws WrongCharException {
		...
		try (Scanner scanner = new Scanner(System.in);) {
			...
			if (answer.contains("AudioFile") || answer.contains("ImgFile")
					|| answer.contains("TextFile")) {
				System.out.println("Wright answer!!!");
			} else {
				throw new WrongCharException("Fatal Error: you'v wrote " + "\""
						+ answer + "\""
						+ " and it is wrong answer so we will die!!!  :)))");
			}
		}
	}
